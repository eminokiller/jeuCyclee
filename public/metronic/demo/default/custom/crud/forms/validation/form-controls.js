...
var KTFormControls = function () {
    ...
    */
/*Begin PVs Form Validation */
var _initPvForm = function () {
    FormValidation.formValidation(
        document.getElementById('pv_form'),
        {
            fields: {
                'cnrps_adminconcoursbundle_acpvs[pvDate]': {
                    validators: {
                        notEmpty: {
                            message: "حقل تاريخ انعقاد المحضر فارغ"
                                               }
                    }
                },
